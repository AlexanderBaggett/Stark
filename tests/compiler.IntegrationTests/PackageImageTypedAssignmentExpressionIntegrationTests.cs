...
public sealed class PackageImageTypedAssignmentExpressionIntegrationTests
{
    [Fact]
    public async Task ManifestBackedTypedAssignmentExpressionsCompileAndRunWithoutSyntheticSource()
    {
        ...
        var tempDirectory = Directory.CreateTempSubdirectory("stark-package-image-typed-assignment-expression-runtime-");
