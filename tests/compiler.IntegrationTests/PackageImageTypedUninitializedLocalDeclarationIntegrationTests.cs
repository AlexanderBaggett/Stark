...
public sealed class PackageImageTypedUninitializedLocalDeclarationIntegrationTests
{
    [Fact]
    public async Task ManifestBackedTypedUninitializedLocalDeclarationsCompileAndRunWithoutSyntheticSource()
    {
        ...
        var tempDirectory = Directory.CreateTempSubdirectory("stark-package-image-typed-uninitialized-local-runtime-");
