...
public sealed class PackageImageTypedDiscardedExpressionIntegrationTests
{
    [Fact]
    public async Task ManifestBackedTypedDiscardedExpressionBodiesCompileAndRunWithoutSyntheticSource()
    {
        ...
        var tempDirectory = Directory.CreateTempSubdirectory("stark-package-image-typed-expression-runtime-");
