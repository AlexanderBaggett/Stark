...
Status: accepted build-layout contract. Current Stage0 behavior is also
documented in [Stark Projects and Solutions](../Userfacing/ProjectsAndSolutions.md).
Remaining Stage1/Stage2 routing work is tracked in
[`docs/Self-host-Prep/TASKS.md`](../Self-host-Prep/TASKS.md).

Stark uses a formal `build/` layout
