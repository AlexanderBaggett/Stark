...
- [ ] Compiler-owned package image architecture
  ...
  - [ ] Use package images to improve optimizer capability
    ...
    - [x] publish structural optimization summaries for generic templates so imported direct/member-call, field/index-access, simple binary/comparison wrappers, and simple explicit-conversion or unary pointer-wrapper planning plus module-private inline promotion can use preserved call/access/operator/unary/branch/loop/object-creation shape instead of relying only on scalar body cost
