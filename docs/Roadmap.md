...
- [ ] Compiler-owned package image architecture
  ...
  - [ ] Use package images to improve optimizer capability
    ...
    - [x] publish structural optimization summaries for generic templates so imported wrapper planning and module-private inline promotion can use preserved call/branch/loop/object-creation shape instead of relying only on scalar body cost
