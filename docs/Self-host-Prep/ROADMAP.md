...
- [~] Add rich assertions for diagnostics, collections, ranges, null/option-like values, and type checks. `System.Testing` now has `NotEqual`, text contains/starts/ends, range, slice/List shape assertions, and keeps text scans allocation-free through `System.Text`; diagnostic/type/root `Option`/`Result` assertions remain. See [04-test-infrastructure-audit.md](04-test-infrastructure-audit.md).
...
- [~] Add process execution with stdout, stderr, exit-code, argv, environment, and working-directory capture. Linux-backed `System.Process` APIs and focused tests have landed; cross-platform backend parity remains. See [04-test-infrastructure-audit.md](04-test-infrastructure-audit.md) and [02-stdlib-gaps.md](02-stdlib-gaps.md).
...
- [~] Expand `System.Testing` to support the ported host test suite. Value/text/range/slice/List assertion helpers, temp fixture helpers, snapshot/golden text helpers, and generated `[Fact]` runners have landed; diagnostic/type/root `Option`/`Result` helpers, process harness integration, and theory/platform support remain. See [02-stdlib-gaps.md](02-stdlib-gaps.md) and [04-test-infrastructure-audit.md](04-test-infrastructure-audit.md).
...
- [~] Add process spawning, environment, argv, working-directory, and output-capture APIs. Linux-backed `System.Process` APIs and focused tests have landed; cross-platform backend parity remains. See [02-stdlib-gaps.md](02-stdlib-gaps.md).
