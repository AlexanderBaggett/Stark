...
{{< stark-sample "samples/generics-basics.stark" >}}
...
{{< stark-sample "samples/generic-option.stark" >}}
...
{{< stark-sample "rejected/trait-runtime-value.stark" >}}
...
{{< stark-sample "samples/doctrine-rules.stark" >}}
