...
{{< stark-sample "samples/borrow-counter.stark" >}}
...
{{< stark-sample "rejected/plain-borrow-return-escape.stark" >}}
...
{{< stark-sample "rejected/null-borrow.stark" >}}
...
{{< stark-sample "samples/borrowing-nonoverlap.stark" >}}
...
{{< stark-sample "rejected/borrowing-overlap-default.stark" >}}
...
{{< stark-sample "samples/memory-separation-contracts.stark" >}}
...
{{< stark-sample "samples/borrowing-unsafe-assume.stark" >}}
...
{{< stark-sample "samples/borrowing-write-destinations.stark" >}}
...
{{< stark-sample "samples/bounded-raw-pointer-regions.stark" >}}
...
{{< stark-sample "samples/borrowing-fnptr-contracts.stark" >}}
